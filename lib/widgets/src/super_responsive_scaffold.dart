...
class SuperResponsiveScaffold extends StatefulWidget {
  const SuperResponsiveScaffold({
    super.key,
  ...
  @override
  State<SuperResponsiveScaffold> createState() => _SuperResponsiveScaffoldState();
}

class _SuperResponsiveScaffoldState extends State<SuperResponsiveScaffold> {
  ...
  @override
  void didUpdateWidget(covariant SuperResponsiveScaffold oldWidget) {
