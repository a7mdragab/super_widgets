        ...
        child: NotificationListener(
          onNotification: (dynamic notification) {
            ...
            if (notification is UserScrollNotification &&
              ...
              if (offset > 0) {
                //animated scroll
                scrollController.animateTo((offset / widthUnit).round() * (widthUnit), duration: const Duration(milliseconds: 100), curve: Curves.easeInOut);
              }
            ...
            child: FullCalendar(
              ...
              onDateChange: (value) {
                ...
                Future.delayed(const Duration(milliseconds: 100), () {
                  ...
                  scrollController.animateTo(newOffset, duration: const Duration(milliseconds: 500), curve: Curves.easeInOut);
...
class _FullCalendarState extends State<FullCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    ///parsing [partsStart] List of Strings to DateTime
    DateTime lastDate = DateTime.parse("${partsEnd.first}-${(int.parse(partsEnd[1]) + 1).toString().padLeft(2, '0')}-01 23:00:00.000").subtract(const Duration(days: 1));
  ...
  Widget daysOfWeek(double width, String? locale) {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: List.generate(7, (index) => dayName(width / 7.0, daysNames[index])));
  }
  ...
  Widget dayName(double width, String text) {
    return Container(
      width: width,
      alignment: Alignment.center,
      child: Txt(text, fontSize: 12.0, fontWeight: FontWeight.w400, color: widget.black!.withOpacity(0.8)),
    );
  }
