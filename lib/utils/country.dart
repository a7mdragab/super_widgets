...
class Country {
  ...
  const Country({required this.name, required this.flag, required this.code, required this.dialCode, required this.minLength, required this.maxLength});

  ///endregion default constructor

  ///region withFields constructor
  const Country.withFields(this.name, this.flag, this.code, this.dialCode, this.minLength, this.maxLength);
...
const Country egyptCountry = Country(
  name: "Egypt",
  flag: "🇪🇬",
  code: "EG",
  dialCode: "20",
...
const Country jordanCountry = Country(
  name: "Jordan",
  flag: "🇯🇴",
  code: "JO",
  dialCode: "962",
...
Country? getCountryByCountryCode(String countryCode) {
  int ind = allCountries.indexWhere((element) => element.code == countryCode);
  return ind == -1 ? null : allCountries[ind];
}
